...
class QxtPop3CommandPrivate : public QObject, public QxtPrivate<QxtPop3Command>
{
    Q_OBJECT
public:
    QxtPop3CommandPrivate();

    QXT_DECLARE_PUBLIC(QxtPop3Command)

    QTimer timer;

    virtual void run();
    QxtPop3Command::Status status;
    int timeout;
    QString errString;
