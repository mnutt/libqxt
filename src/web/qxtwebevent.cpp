...
/*!
 * \variable const int QxtWebEvent::sessionID
...
/*!
 * \variable const int QxtWebRequestEvent::requestID
...
/*!
 * \variable QPointer<QIODevice> QxtWebPageEvent::dataSource
 * Data will be read from this device and relayed to the web browser.
 */

/*!
 * \variable bool QxtWebPageEvent::chunked
...
/*!
 * \variable bool QxtWebPageEvent::streaming
...
/*!
 * \variable const int QxtWebPageEvent::requestID
 * Contains the opaque requestID provided by QxtWebRequestEvent.
 */

/*!
 * \variable int QxtWebPageEvent::status
...
/*!
 * \variable QByteArray QxtWebPageEvent::statusMessage
...
/*!
 * \variable QByteArray QxtWebPageEvent::contentType
...
/*!
 * \variable QString QxtWebStoreCookieEvent::name
 * Contains the name of the cookie to be stored.
 */

/*!
 * \variable QString QxtWebStoreCookieEvent::data
 * Contains the content of the cookie to be stored.
 */

/*!
 * \variable QDateTime QxtWebStoreCookieEvent::expiration
...
/*!
 * \variable QString QxtWebRemoveCookieEvent::name
...
/*!
 * \variable QString QxtWebRedirectEvent::destination
