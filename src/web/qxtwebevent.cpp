...
/*!
 * \value const int QxtWebEvent::sessionID
...
/*!
 * \value const int QxtWebRequestEvent::requestID
...
/*!
 * \value QPointer<QIODevice> QxtWebPageEvent::dataSource
 * Data will be read from this device and relayed to the web browser.
 */

/*!
 * \value bool QxtWebPageEvent::chunked
...
/*!
 * \value bool QxtWebPageEvent::streaming
...
/*!
 * \value const int QxtWebPageEvent::requestID
 * Contains the opaque requestID provided by QxtWebRequestEvent.
 */

/*!
 * \value int QxtWebPageEvent::status
...
/*!
 * \value QByteArray QxtWebPageEvent::statusMessage
...
/*!
 * \value QByteArray QxtWebPageEvent::contentType
...
/*!
 * \value QString QxtWebStoreCookieEvent::name
 * Contains the name of the cookie to be stored.
 */

/*!
 * \value QString QxtWebStoreCookieEvent::data
 * Contains the content of the cookie to be stored.
 */

/*!
 * \value QDateTime QxtWebStoreCookieEvent::expiration
...
/*!
 * \value QString QxtWebRemoveCookieEvent::name
...
/*!
 * \value QString QxtWebRedirectEvent::destination
