...
/**
 * Sets the interface on which the session manager will listen for incoming
 * connections.
 * 
...
/**
 * Returns true if sessions are automatically created for every connection
...
/**
 * Sets whether sessions are automatically created for every connection
...
/**
 * Sets the QxtAbstractWebService that is used to respond to requests from
 * connections that are not associated with a session.
 *
