...
class QxtWebHttpConnectorPrivate : public QTcpServer,public QxtPrivate<QxtWebHttpConnector>
{
    QXT_DECLARE_PUBLIC(QxtWebHttpConnector);
};




class QxtWebHttpConnection  : public QxtWebStatelessConnection
{
Q_OBJECT
public:
...
private:
    friend class QxtWebHttpConnector;

    QxtWebHttpConnection(QTcpSocket * socket, QObject *parent):QxtWebStatelessConnection(parent)
    {
